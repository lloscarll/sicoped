    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box-header with-border">
          ...
          echo form_open_multipart("admin/pencegahan/edit/".$old_value['pencegahan_id'],$attributes);
          ?>
        <div class="box-body">
        <div class="form-group">
        <label for="pencegahan_judul" class="control-lable">Title</label>
          <input name="pencegahan_judul" type="text" class="form-control" id="pencegahan_judul" placeholder="judul" value="<?php echo $old_value["pencegahan_judul"];?>">
        ...
        <div class="form-group">
        <label for="pencegahan_judul" class="control-lable">Status</label></br>
        ...
        <label for="pencegahan_deskripsi" class="control-lable">Content</label>
            <textarea  name="pencegahan_deskripsi" id="editor1"  placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $old_value["pencegahan_deskripsi"];?></textarea>
