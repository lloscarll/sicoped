    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box-header with-border">
          ...
          echo form_open_multipart("admin/edukasi/add",$attributes);
          ?>
        <div class="box-body">
        <div class="form-group">
        <label for="edukasi_judul" class="control-lable">Title</label>
          <input name="edukasi_judul" type="text" class="form-control" id="edukasi-judul" placeholder="judul" value="<?php echo set_value("edukasi_judul");?>">
