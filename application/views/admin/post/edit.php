    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box-header with-border">
          ...
          echo form_open_multipart("admin/post/edit/".$old_value['post_id'],$attributes);
          ?>
        <div class="box-body">
        <div class="form-group">
        <label for="post_title" class="control-lable">Title</label>
          <input name="post_title" type="text" class="form-control" id="post-title" placeholder="judul" value="<?php echo $old_value["post_title"];?>">
        </div>
        <div class="form-group">
        ...
        <label for="post_description" class="control-lable">Content</label>
            <textarea  name="post_description" id="editor1"  placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $old_value["post_description"];?></textarea>
        </div>
        </div>
